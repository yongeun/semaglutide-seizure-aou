...
files <- c(
  ...
  "OTHER_GLPA_vs_SGLT2_other_glpa_epilepsy_seizure_full_cohort_20260213_053619.csv",
  "OTHER_GLPA_vs_OtherGLD_other_glpa_epilepsy_seizure_full_cohort_20260213_053619.csv",
  "SGLT2_vs_OtherGLD_sglt2_epilepsy_seizure_full_cohort_20260213_053619.csv"
)
...
# >>> CELL 20: Main IPTW Analysis Loop (Outcome 4 - all_ages only) <<<
config <- get_standard_config()

# Only all_ages for Outcome 4
analysis_types <- list(
...
message("IPTW analysis for Outcome 4 (Epilepsy/Seizure excl Hypoglycemic) completed.")
...
visualize_combined_bootstrap <- function(comparisons, outcome="Epilepsy/Seizure excl Hypoglycemic", analysis_prefix="outcome4_epilepsy_excl_hypo_all_ages_tmle", colors=NULL, use_jama_style=TRUE, plot_type="multi") {
...
visualize_combined_bootstrap(
  ...
  analysis_prefix = "outcome4_epilepsy_excl_hypo_all_ages_tmle",
